...
<div class="container my-4">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Редактировать ноутбук</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('laptop.update', ['id' => $laptop->id]) }}" enctype='multipart/form-data'>
                    @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control"
                                       name="title" value="{{ $laptop->title }}" required autocomplete="title" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="processorId" class="form-control">
                                    @foreach ($processors as $processor)
                                        <option value="{{ $processor['id'] }}" selected>{{ $processor['title'] . ' ' . $processor['brand']['title'] . ' ' . $processor['type']['title']  . ' ' . $processor['model']['title'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <select name="videoCardId" class="form-control">
                                    @foreach ($videoCards as $videoCard)
                                        <option selected value="{{ $videoCard['id'] }}">{{ $videoCard['title'] . ' ' . $videoCard['brand']['title'] . ' ' . $videoCard['model']['title'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ramMemory" type="text" class="form-control"
                                       name="ramMemory" value="{{ $laptop->ram_memory }}" required autocomplete="ramMemory" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="memory" type="text" class="form-control"
                                       name="memory" value="{{ $laptop->memory }}" required autocomplete="memory" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="diagonal" type="text" class="form-control"
                                       name="diagonal" value="{{ $laptop->diagonal }}" required autocomplete="diagonal" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="screenResolution" type="text" class="form-control"
                                       name="screenResolution" value="{{ $laptop->screen_resolution }}" required autocomplete="screenResolution" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="text" class="form-control"
                                       name="price" value="{{ $laptop->price }}" required autocomplete="price" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="text" class="form-control"
                                       name="quantity" value="{{ $laptop->quantity }}" required autocomplete="quantity" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
